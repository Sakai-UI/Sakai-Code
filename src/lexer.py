...
class PyCustomLexer(QsciLexerCustom):
  ...
  def __init__(self, parent):
    ...
    self.setDefaultFont(QFont("JetBrains Mono", 10))
    ...
    self.setColor(QColor("#FF8CCE"), self.KEYWORD)
    self.setColor(QColor("#FF8CCE"), self.TYPES)
    self.setColor(QColor("#F6C177"), self.STRING)
    self.setColor(QColor("#F6C177"), self.KEYARGS)
    self.setColor(QColor("#EB6F92"), self.BRACKETS)
    self.setColor(QColor("#908caa"), self.COMMENTS)
    self.setColor(QColor("#C4A7E7"), self.CONSTANTS)
    self.setColor(QColor("#C4A7E7"), self.FUNCTIONS)
    self.setColor(QColor("#FF8CCE"), self.CLASSES)
    self.setColor(QColor("#EB6F92"), self.FUNCTION_DEF)
    ...
    # Font
    self.setFont(QFont("JetBrains Mono", 10, weight=QFont.Bold), self.DEFAULT)
    self.setFont(QFont("JetBrains Mono", 10, weight=QFont.Bold), self.KEYWORD)
    self.setFont(QFont("JetBrains Mono", 10, weight=QFont.Bold), self.CLASSES)
    self.setFont(QFont("JetBrains Mono", 10, weight=QFont.Bold), self.FUNCTION_DEF)
